...
- [x] Dolby Vision RPU 保留链路强制音频 Copy，并在草稿、模板恢复和后端执行计划中统一校验；MKV 作为全轨归档输出，MP4 仅开放 Profile 8.1 + AAC/AC-3/E-AC-3（含 E-AC-3 JOC Atmos）兼容路线，TrueHD Atmos、字幕和附件需使用 MKV
